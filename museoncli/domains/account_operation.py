    ...
    return [
        CommandSpec(
            ...
            summary=(
                ...
                "an account_publish allocation is atomically transferred when no scheduled, "
                "generating, generated, or publishing work remains, while existing publish "
                "configuration is preserved. Otherwise the API returns "
                "account_publish_schedule_conflict with blocking_schedule_counts. "
        ...
        CommandSpec(
            ...
            summary=(
                ...
                "An idle account_publish holder is transferred automatically during submit; "
                "outcome='account_publish_schedule_conflict' means scheduled, generating, "
                "generated, or publishing work still blocks that transfer. Report "
                "blocking_schedule_counts; cancel eligible work or wait for publishing to "
                "finish, then retry after confirmation. "
            ...
            output_schema=_direct_output_schema(
                ...
                "occupied_by_type, occupied_by_related_id, blocking_schedule_counts, "
