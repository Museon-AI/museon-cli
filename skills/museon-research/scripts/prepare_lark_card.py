...
def main() -> int:
    ...
    parser.add_argument(
        "--admin-base-url",
        default="https://museon-hireaicreator.vercel.app/hook-format/social-analysis",
        help="HireAICreator app page used after a successful form submission",
    )
