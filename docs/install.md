...
1. Confirm that Python 3.11+ and `uv` are available, then install the exact
   ...
   ```bash
   uv tool install "https://github.com/Museon-AI/museon-cli/releases/download/v0.5.12/museoncli-0.5.12-py3-none-any.whl"
   ```
...
https://github.com/Museon-AI/museon-cli/tree/v0.5.12/skills/museon-cli
https://github.com/Museon-AI/museon-cli/tree/v0.5.12/skills/social-media-hook-analyze
