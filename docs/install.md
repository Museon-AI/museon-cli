...
1. Confirm that Python 3.11+ and `uv` are available, then install the exact
   ...
   ```bash
   uv tool install "https://github.com/Museon-AI/museon-cli/releases/download/v0.7.0/museoncli-0.7.0-py3-none-any.whl"
   ```
...
https://github.com/Museon-AI/museon-cli/tree/v0.7.0/skills/museon-content-workflow-base
https://github.com/Museon-AI/museon-cli/tree/v0.7.0/skills/museon-research
https://github.com/Museon-AI/museon-cli/tree/v0.7.0/skills/museon-content-workflow-hireaicreator
https://github.com/Museon-AI/museon-cli/tree/v0.7.0/skills/museon-content-workflow-ai-slideshow
https://github.com/Museon-AI/museon-cli/tree/v0.7.0/skills/museon-content-workflow-campaign-monitor
