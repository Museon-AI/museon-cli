...
1. Confirm that Python 3.11+ and `uv` are available, then install the exact
   ...
   ```bash
   uv tool install "https://github.com/Museon-AI/museon-cli/releases/download/v0.3.78/museoncli-0.3.78-py3-none-any.whl"
   ```
...
https://github.com/Museon-AI/museon-cli/tree/v0.3.78/skills/museon-cli
