...
1. Confirm that Python 3.11+ and `uv` are available, then install the exact
   ...
   ```bash
   uv tool install "https://github.com/Museon-AI/museon-cli/releases/download/v0.7.1/museoncli-0.7.1-py3-none-any.whl"
   ```
...
all five bundled workflow Skills as `installed`
or `current` and includes their destination paths.
...
https://github.com/Museon-AI/museon-cli/tree/v0.7.1/skills/museon-content-workflow-base
https://github.com/Museon-AI/museon-cli/tree/v0.7.1/skills/museon-research
https://github.com/Museon-AI/museon-cli/tree/v0.7.1/skills/museon-content-workflow-hireaicreator
https://github.com/Museon-AI/museon-cli/tree/v0.7.1/skills/museon-content-workflow-ai-slideshow
https://github.com/Museon-AI/museon-cli/tree/v0.7.1/skills/museon-content-workflow-campaign-monitor
